...
from constraint_aware_neural_networks.models.iso_euler.constraint import (
    Approximate_Iso_Euler_Constraint_Resolving_Layer,
    Iso_Euler_Constraint_Loss,
    # Iso_Euler_Constraint_Resolving_Layer,
    compute_iso_euler_constraint_deviation,
)
from constraint_aware_neural_networks.models.model_types import Model_Type


def setup_iso_euler_model_configuration(
    data_directory: Path,
    ...
    """
    Sets everything up for the training of the isothermal Euler model.

    .. note::
        Modify the values in this function if you want to adapt something.
    """
    feature_names = ["rhol", "ml", "rhor", "mr"]
    label_names = ["rhol_s", "ml_s", "rhor_s", "mr_s", "s"]

    parameters = NN_Parameters(
        algorithm_name=algorithm_type,
        model_name=Model_Type.ISOTHERMAL_EULER.value,
        ...
        constraint_deviation_function=compute_iso_euler_constraint_deviation,
        constraint_loss_function=Iso_Euler_Constraint_Loss(),
        constraint_resolving_layer=Approximate_Iso_Euler_Constraint_Resolving_Layer(),
        net_topology=[30] * 5,
    )
